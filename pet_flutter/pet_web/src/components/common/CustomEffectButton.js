...
// Shake Effect
export const showShakeEffect = (node, { component }) => {
  if (component !== 'Button') {
    return;
  }
...
export const CustomEffectButton = ({ children, effect, ...props }) => {
  return (
    <ConfigProvider
      wave={{ showEffect: effect === 'shake' ? showShakeEffect : showInsetEffect }}
    >
